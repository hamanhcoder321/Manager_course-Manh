...
// Kiểm tra website đang chạy HTTPS hay HTTP, Hosting thường dùng https, Local thường là http
// define('_HOST_URL',(isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST']);


// nó luôn dựa vào domain ở máy nên chạy hosting ko chạy đc 
